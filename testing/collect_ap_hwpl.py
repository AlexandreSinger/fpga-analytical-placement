...
def command_parser():
    ...
    parser.add_argument("-is_simulated_annealing_placer", action="store_true", help="This flag tells the script that it is parsing output generated by simulated annealing placer")
